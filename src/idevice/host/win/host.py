...
platform agnostic; this class mirrors :class:`~idevice.host.mac.host.MacHost`
and exists to give Windows controllers a real, non-dummy host.
"""
...
class WindowsHost(HostBase):
    ...
    @classmethod
    def from_env(cls) -> WindowsHost:
        """Build a :class:`WindowsHost` from the ``GAUTO_*`` environment variables.
        ...
        Returns:
            WindowsHost: A host bound to the keeper/device described by the
            environment.
